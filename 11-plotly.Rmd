...
<!--- cut this text ---> [To start plotting we will create an empty plotly object. We will call it pizza plot but you can call it what you like. 
...
```{r}
plot_ly(pcy, x = pubyear, y = n, color = pubcountry)
```

If we do this then plotly will record a warning that the colour palatte has a maximum number of 8 colors. This means that some countries will share a colour. ##To change this xxx##
