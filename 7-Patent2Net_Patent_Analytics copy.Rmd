...
![_config.yml](images/p2net_figures/query.png)
...
![_config.yml](images/p2net_figures/developerquery.png)
...
![_config.yml](images/p2net_figures/result2.png)

The abstracts folder contained the abstracts and some basic identifier details

![_config.yml](images/p2net_figures/abstracts.png)
...
![_config.yml](images/p2net_figures/application.png)
...
![_config.yml](images/p2net_figures/query2.png)
