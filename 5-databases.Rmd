...
![_config.yml](images/tools/simplesearchresultspizza.png)
...
![_config.yml](images/tools/pctseq.png)

**5. [Google Patents](http://www.google.com/patents)**

![_config.yml](images/tools/googlepatents_2015-0517_14-09-22.png)
...
**6. [Google Prior Art Finder](https://www.google.com/patents/related)**
...
**7. [Google USPTO Bulk download](https://www.google.com/googlebooks/uspto.html)**
...
![_config.yml](images/tools/USPTObulk.png)
...
![_config.yml](images/tools/USPTOGrant.png)
...
**8. [The Lens](https://www.lens.org/lens/)**
...
![_config.yml](images/tools/Lens_2015-0517_14-19-26.png)
...
![_config.yml](images/tools/Freepatentsonline2015-03-26\ 16-26-13.png)

**10. [DEPATISnet](http://www.dpma.de/english/service/e-services/depatisnet/)**
...
![_config.yml](images/tools/DEPATISnet_13-53-19.png)

**11. [OECD Patent Databases](http://www.oecd.org/sti/inno/oecdpatentdatabases.htm)**
...
![_config.yml](images/tools/OECD_patent_databases.png)
...
**12 [EPO World Patent Statistical Database](https://www.epo.org/searching-for-patents/business/patstat.html)
...
![_config.yml](images/tools/patstat.png)
...
![_config.yml](images/tools/PIUG_Wiki_2015-0517_15-45-05.png)
...
![_config.yml](images/tools/Intellogist_2015-0517_16-03-52.png)
...
**13. [Patent2Net](https://github.com/Patent2net/Patent2Net) in Python**

A tool to access and process the data from the European Patent Office OPS service. 

![_config.yml](images/tools/Patent2Net_GitHub_2015-0517_15-49-58.png)

**14. [Python EPO OPS Client](https://github.com/55minutes/python-epo-ops-client) by Gsong**

A Python client for OPS access developed by Gsong and freely available on GitHub. Used in Patent2Net above. 

![_config.yml](images/tools/python-epo-ops-client-GitHub_2015-0517_15-53-34.png)

**15. [Fung Institute Patent Server](https://github.com/funginstitute/patentserver) for USPTO data in JSON**
...
![_config.yml](images/tools/funginstitutepatentserver.png)

##Round Up

That should be more than enough to get started with patent data and hopefully adds some useful pieces of information for long term patent professionals. Please feel welcome to add comments and suggestions on important free resources to the online version of the Manual. 
