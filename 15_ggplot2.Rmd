...
```{r publication_country_nopipe, eval=FALSE}
...
```
<!---![_config.yml](images/fggplot2/fig1_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig2_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig3_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig4_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig5_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig6_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig7_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig8_gplot2-1.png)--->
...
<!---desnt know how to add scale_color_tableau--->
```{r fig9_gplot2}
...
<!---![_config.yml](images/fggplot2/fig9_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig10_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig11_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig12_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig13_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig14_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig15_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig16_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig17_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig18_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig19_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig20_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig21_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig22_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig23_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig24_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig25_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig26_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig27_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig28_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig29_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig30_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig32_gplot2-1.png)--->
...
<!---INSERT PLOTLY HERE
What if we wanted to edit and perhaps share this plot in an online environment and to make the figure interactive. The plotly package in R (introduced in a separate chapter in this Manual) provides exactly these possibility.The `plotly` package is integrated with `ggplot2` package through the `ggplotly()` function with examples provided [here](https://plot.ly/ggplot2/)--->
...
<!---![_config.yml](images/fggplot2/fig33_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig34_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig35_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig36_gplot2-1.png)--->
...
A coxcomb plot is generally associated with Florence Nightingales representation of the causes of mortality among the British Army in the Crimean War that can be viewed [here]().
...
<!---![_config.yml](images/fggplot2/fig37_gplot2-1.png)--->
...
<!---![_config.yml](images/fggplot2/fig38_gplot2-1.png)--->
