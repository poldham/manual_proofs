...
![config.yml](images/openrefine/OpenRefine-2015-06-01\ 12-18-34.png)
...
![_config.yml](images/openrefine/create_project.png)
...
![_config.yml](images/openrefine/create_project2.png)
...
![_config.yml](images/openrefine/menu_basics.png)
...
![_config.yml](images/openrefine/facet_menu.png)
...
![_config.yml](images/openrefine/reorder_columns.png)
...
![_config.yml](images/openrefine/undo_redo.png)
...
![_config.yml](images/openrefine/cleaning_pubno_createfacet.png)
...
![_config.yml](images/openrefine/cleaning_pubno_totitlecase.png)
...
![_config.yml](images/openrefine/title_trailingwhitespace.png)
...
![_config.yml](images/openrefine/add_column_publicationyear.png)
...
![_config.yml](images/openrefine/split_date.png)
...
![_config.yml](images/openrefine/rename_column.png)
...
![_config.yml](images/openrefine/replace_encoding.png)
...
![_config.yml](images/openrefine/transform.png)

This produces a menu where we enter a simple GREL replace code. 

![_config.yml](images/openrefine/transform_replace_date.png)
...
![_config.yml](images/openrefine/publication_country.png)
...
![_config.yml](images/openrefine/blank_na_facets.png)
...
![_config.yml](images/openrefine/split_applicants_columns.png)

We then need to select the separator. In this case (and normally with patent data), it is `;`. 

![_config.yml](images/openrefine/split_selectseparator.png)

This will produce a set of 18 columns.

![_config.yml](images/openrefine/split_columns.png)
...
![_config.yml](images/openrefine/split_multivaluedcells.png)
...
![_config.yml](images/openrefine/split_multivaluedcells2.png)
...
![_config.yml](images/openrefine/split_filldown.png)
...
![_config.yml](images/openrefine/applicants_titlecase.png)

We now move back to the applicants and select `Facet > Text Facet`.

![_config.yml](images/openrefine/applicants_textfacet.png)
...
![_config.yml](images/openrefine/applicants1.png)
...
![_config.yml](images/openrefine/cluster_step1.png)
...
![_config.yml](images/openrefine/applicants2.png)
...
![_config.yml](images/openrefine/applicants-ngramfingerprint2.png)
...
![_config.yml](images/openrefine/ngram1_problems.png)
...
![_config.yml](images/openrefine/applicants_metaphone3.png)
...
![_config.yml](images/openrefine/applicants_browsecluster.png)
...
![_config.yml](images/openrefine/applicants_browsecluster1.png)
...
![_config.yml](images/openrefine/applicants_cologne.png)
...
![_config.yml](images/openrefine/applicants_levenshtein.png)
