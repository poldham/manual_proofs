...
This chapter provides an overview of the open source and free software tools that are available for patent analytics. The aim of the chapter is to serve as a quick reference guide for some of the main tools in the tool kit. We will go into some of these tools in more depth elsewhere in the WIPO Open Source Patent Analytics Manual and leave you to explore the rest of the tools for yourself. 
...
![_config.yml](images/overview/google_sheets_addon.png)
...
![_config.yml](images/overview/Fusion-Tables.png)
...
![_config.yml](images/overview/Fusion-Tables-Cards.png)

![_config.yml](images/overview/Fusion-Tables-Map.png)
...
![_config.yml](images/openrefine/OpenRefine-download.png)
...
![_config.yml](images/overview/RStudio.png)
...
![_config.yml](images/overview/RapidMiner.png)

3. [KNIME](http://www.knime.org)

An open platform for data mining. 

![_config.yml](images/overview/KNIME.png)
...
![_config.yml](images/tableau/dashboard_completed.png)
...
![_config.yml](images/overview/Shiny.png)
...
![_config.yml](images/overview/Radiant.png)
...
![_config.yml](images/overview/manyeyes.png)

***5.	Other visualization Tools***
...
![_config.yml](images/overview/synbio.png)
...
![_config.yml](images/overview/animals.png)
...
![_config.yml](images/overview/breeds_cluster.png)
...
***1. [Gephi](https://gephi.github.io)*** is Java based open source network generating software. It can cope with large datasets (depending on your computer) to produce powerful visualizations.

![_config.yml](images/overview/Gephi.png)
...
![_config.yml](images/overview/NodeXL.png)
...
![_config.yml](images/overview/cytoscape.png)
...
![_config.yml](images/overview/Pajek.png)
...
![_config.yml](images/overview/VOSviewer.png)
...
![_config.yml](images/overview/HivePlots.png)
...
![_config.yml](images/overview/OpenStreetMap.png)

[Leaflet](http://leafletjs.com)

A very popular Open Source JavaScript library for interactive maps

![_config.yml](images/overview/Leaflet.png)
...
![_config.yml](images/overview/tableaumap.png)
...
![_config.yml](images/overview/QGIS.png)
...
![_config.yml](images/overview/valuing1.png)
...
![_config.yml](images/overview/D3.png)

[Highcharts](http://www.highcharts.com)

Free for non-commercial use with a variety of pricing plans.

![_config.yml](images/overview/highcharts.png)
...
![_config.yml](images/overview/Datawrapper.png)
...
![_config.yml](images/overview/Plotly.png)
...
![_config.yml](images/overview/Jigsaw.png)

***2. [Weka](http://www.cs.waikato.ac.nz/ml/weka/)*** 

Java based text mining software. 

![_config.yml](images/overview/Weka.png)
...
![_config.yml](images/overview/Word-Trees.png)

and [Jason Davies](https://www.jasondavies.com/wordtree/) tree creator. 

![_config.yml](images/overview/Word-Tree-Davies.png)
...
![_config.yml](images/overview/KHCoder.png)
...
![_config.yml](images/overview/ntlk.png)
